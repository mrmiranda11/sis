...
import com.experian.eda.decisionagent.discovery.codegen.xmlinterface.XMLSchemaV4GeneratorSupport
...
public class XMLCodeGenV4 extends SMCodeGenerator {

    protected static final ExpLogger logger     = new ExpLogger(this);

    public XMLCodeGenV4(File serFile, String outFolder) {
    ...
    protected Map<String, InputStream> getGeneratorMap(IExecutableStrategy execStrat, Strategy strategy) {
        ...
        XMLSchemaV4GeneratorSupport obj = new XMLSchemaV4GeneratorSupport();
