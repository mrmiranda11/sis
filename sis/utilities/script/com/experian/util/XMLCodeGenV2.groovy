...
import com.experian.eda.decisionagent.discovery.codegen.xmlinterface.XMLV2CodeGeneratorSupport
...
public class XMLCodeGenV2 extends SMCodeGenerator {

    protected static final ExpLogger logger     = new ExpLogger(this);

    public XMLCodeGenV2(File serFile, String outFolder) {
    ...
    protected Map<String, InputStream> getGeneratorMap(IExecutableStrategy execStrat, Strategy strategy) {
        ...
        XMLV2CodeGeneratorSupport obj = new XMLV2CodeGeneratorSupport();
