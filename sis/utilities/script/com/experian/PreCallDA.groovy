...
/**
 *   PreCallDA
 *   This class allows customizing the NBSM Builtin component before 
 *   creating the InputAreas and calling the DA 
 *   <p>
 ...
 *
 */        
public class PreCallDA implements GroovyComponent<Message> {
    ...
    public String processMessage(final Message message, final Map<String, String> dataMap) throws Exception {
        ...
        logger.debug "PreCallDA>>"
        //Component must return TR_SUCCESS
        return TR_SUCCESS;
    }
